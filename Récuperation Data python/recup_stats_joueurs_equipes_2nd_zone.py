...
def get_fbref_player_stats(lst_league_names, lst_seasons):
    ...
    for season in seasons:
        ...
        for league_name_long in league_names_long:
            ...
            if not os.path.exists(os.path.join(data_dir_fbref +f'/raw/outfield/fbref_outfield_player_stats_minor_combined_latest.csv')):
                ...
                ##### Save DataFrame
                df_all.to_csv(data_dir_fbref + f'/raw/outfield/{league_name_long}/{season}/fbref_outfield_player_stats_{league_name_long}_{season}_latest_minor.csv', index=None, header=True)        
    ...
    all_files = glob.glob(os.path.join(data_dir_fbref + f'/raw/outfield/*/*/fbref_outfield_player_stats_*_*_latest_minor.csv'))
