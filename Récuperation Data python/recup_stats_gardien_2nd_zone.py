...
lst_data_types = ['goalkeeper', 'goalkeeper', 'team']
...
df_fbref_goalkeeper_raw = get_fbref_player_stats(lst_league_names, lst_seasons)
...
try:
    frame = df_fbref_goalkeeper_raw.to_sql(tableName, dbConnection, if_exists='replace');
