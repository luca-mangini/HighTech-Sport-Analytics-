...
def get_fbref_squad_stats_player(lst_league_names, lst_seasons):
    ...
    os.remove(os.path.join(data_dir_fbref +f'/raw/team/fbref_team_player_stats_against_combined_latest.csv'))
    ...
    for season in seasons:
        ...
        for league_name_long in league_names_long:
            ...
            if not os.path.exists(os.path.join(data_dir_fbref +f'/raw/team/fbref_team_player_stats_against_combined_latest.csv')):
                ...
                if(saison_name_short!=""):
                  ...
                  url_std_stats = f'https://widgets.sports-reference.com/wg.fcgi?css=1&site=fb&url=%2Fen%2Fcomps%2F{league_name_short}%2F{saison_name_short}%2Fstats%2Fplayers%2F{season}-{league_name_long}&div=div_stats_squads_standard_against'
                  df_std_stats = pd.read_html(url_std_stats, header=1)[0]
                  
                  ##### Shooting stats
                  print(f'Scraping Shooting stats...')
                  url_shooting = f'https://widgets.sports-reference.com/wg.fcgi?css=1&site=fb&url=%2Fen%2Fcomps%2F{league_name_short}%2F{saison_name_short}%2Fshooting%2Fplayers%2F{season}-{league_name_long}&div=div_stats_squads_shooting_against'
                  df_shooting = pd.read_html(url_shooting, header=1)[0]

                  ##### Passing stats
                  print(f'Scraping Passing stats...')
                  url_passing = f'https://widgets.sports-reference.com/wg.fcgi?css=1&site=fb&url=%2Fen%2Fcomps%2F{league_name_short}%2F{saison_name_short}%2Fpassing%2Fplayers%2F{season}-{league_name_long}&div=div_stats_squads_passing_against'
                  df_passing = pd.read_html(url_passing, header=1)[0]

                  ##### Pass Types stats
                  print(f'Scraping Pass Types stats...')
                  url_passing_types = f'https://widgets.sports-reference.com/wg.fcgi?css=1&site=fb&url=%2Fen%2Fcomps%2F{league_name_short}%2F{saison_name_short}%2Fpassing_types%2Fplayers%2F{season}-{league_name_long}&div=div_stats_squads_passing_types_against'
                  ...
                  url_gca = f'https://widgets.sports-reference.com/wg.fcgi?css=1&site=fb&url=%2Fen%2Fcomps%2F{league_name_short}%2F{saison_name_short}%2Fgca%2Fplayers%2F{season}-{league_name_long}&div=div_stats_squads_gca_against'
                  df_gca = pd.read_html(url_gca, header=1)[0]

                  ##### Defensive Actions stats
                  print(f'Scraping Defensive Actions stats...')
                  url_defense = f'https://widgets.sports-reference.com/wg.fcgi?css=1&site=fb&url=%2Fen%2Fcomps%2F{league_name_short}%2F{saison_name_short}%2Fdefense%2Fplayers%2F{season}-{league_name_long}&div=div_stats_squads_defense_against'
                  df_defense = pd.read_html(url_defense, header=1)[0]

                  ##### Possession stats
                  print(f'Scraping Possession stats...')
                  url_possession = f'https://widgets.sports-reference.com/wg.fcgi?css=1&site=fb&url=%2Fen%2Fcomps%2F{league_name_short}%2F{saison_name_short}%2Fpossession%2Fplayers%2F{season}-{league_name_long}&div=div_stats_squads_possession_against'
                  ...
                  url_playing_time = f'https://widgets.sports-reference.com/wg.fcgi?css=1&site=fb&url=%2Fen%2Fcomps%2F{league_name_short}%2F{saison_name_short}%2Fplayingtime%2Fplayers%2F{season}-{league_name_long}&div=div_stats_squads_playing_time_against'
                  df_playing_time = pd.read_html(url_playing_time, header=1)[0]

                  ##### Miscellaneous stats
                  print(f'Scraping Miscellaneous stats...')
                  url_misc = f'https://widgets.sports-reference.com/wg.fcgi?css=1&site=fb&url=%2Fen%2Fcomps%2F{league_name_short}%2F{saison_name_short}%2Fmisc%2Fplayers%2F{season}-{league_name_long}&div=div_stats_squads_misc_against'
                  ...
                  ##### Shooting stats
                  print(f'Scraping Shooting stats...')
                  url_shooting = f'https://widgets.sports-reference.com/wg.fcgi?css=1&site=fb&url=%2Fen%2Fcomps%2F{league_name_short}%2Fshooting%2Fplayers%2F{season}-{league_name_long}&div=div_stats_squads_shooting_against'
                  df_shooting = pd.read_html(url_shooting, header=1)[0]

                  ##### Passing stats
                  print(f'Scraping Passing stats...')
                  url_passing = f'https://widgets.sports-reference.com/wg.fcgi?css=1&site=fb&url=%2Fen%2Fcomps%2F{league_name_short}%2Fpassing%2Fplayers%2F{season}-{league_name_long}&div=div_stats_squads_passing_against'
                  df_passing = pd.read_html(url_passing, header=1)[0]

                  ##### Pass Types stats
                  print(f'Scraping Pass Types stats...')
                  url_passing_types = f'https://widgets.sports-reference.com/wg.fcgi?css=1&site=fb&url=%2Fen%2Fcomps%2F{league_name_short}%2Fpassing_types%2Fplayers%2F{season}-{league_name_long}&div=div_stats_squads_passing_types_against'
                  df_passing_types = pd.read_html(url_passing_types, header=1)[0]

                  ##### Goals and Shot Creation stats
                  print(f'Scraping Goals and Shot Creation stats...')
                  url_gca = f'https://widgets.sports-reference.com/wg.fcgi?css=1&site=fb&url=%2Fen%2Fcomps%2F{league_name_short}%2Fgca%2Fplayers%2F{season}-{league_name_long}&div=div_stats_squads_gca_against'
                  df_gca = pd.read_html(url_gca, header=1)[0]

                  ##### Defensive Actions stats
                  print(f'Scraping Defensive Actions stats...')
                  url_defense = f'https://widgets.sports-reference.com/wg.fcgi?css=1&site=fb&url=%2Fen%2Fcomps%2F{league_name_short}%2Fdefense%2Fplayers%2F{season}-{league_name_long}&div=div_stats_squads_defense_against'
                  df_defense = pd.read_html(url_defense, header=1)[0]

                  ##### Possession stats
                  print(f'Scraping Possession stats...')
                  url_possession = f'https://widgets.sports-reference.com/wg.fcgi?css=1&site=fb&url=%2Fen%2Fcomps%2F{league_name_short}%2Fpossession%2Fplayers%2F{season}-{league_name_long}&div=div_stats_squads_possession_against'
                  df_possession = pd.read_html(url_possession, header=1)[0]
                  df_possession = df_possession.rename({'Att': 'Att_dribbles'}, axis=1)
                  
                  ##### Playing Time stats
                  print(f'Scraping Playing Time stats...')
                  url_playing_time = f'https://widgets.sports-reference.com/wg.fcgi?css=1&site=fb&url=%2Fen%2Fcomps%2F{league_name_short}%2Fplayingtime%2Fplayers%2F{season}-{league_name_long}&div=div_stats_squads_playing_time_against'
                  df_playing_time = pd.read_html(url_playing_time, header=1)[0]

                  ##### Miscellaneous stats
                  print(f'Scraping Miscellaneous stats...')
                  url_misc = f'https://widgets.sports-reference.com/wg.fcgi?css=1&site=fb&url=%2Fen%2Fcomps%2F{league_name_short}%2Fmisc%2Fplayers%2F{season}-{league_name_long}&div=div_stats_squads_misc_against'
                  df_misc = pd.read_html(url_misc, header=1)[0]
