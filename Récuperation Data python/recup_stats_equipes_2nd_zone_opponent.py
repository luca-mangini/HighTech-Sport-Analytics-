...
def get_fbref_squad_stats_player(lst_league_names, lst_seasons):
    ...
    os.remove(os.path.join(data_dir_fbref +f'/raw/team/fbref_team_minor_player_stats_against_combined_latest.csv'))
    ...
    for season in seasons:
        ...
        for league_name_long in league_names_long:
            ...
            if not os.path.exists(os.path.join(data_dir_fbref +f'/raw/team/fbref_team_minor_player_stats_against_combined_latest.csv')):
                ...
                ##### Save DataFrame
                df_all.to_csv(data_dir_fbref + f'/raw/team/{league_name_long}/{season}/fbref_team_minor_player_stats_against_{league_name_long}_{season}_latest.csv', index=None, header=True)        
                
                ##### Export a copy to the 'archive' subfolder, including the date
                df_all.to_csv(data_dir_fbref + f'/raw/team/{league_name_long}/{season}/archive/fbref_team_minor_player_stats_against_{league_name_long}_{season}_last_updated_{today}.csv', index=None, header=True)        
    ...
    all_files = glob.glob(os.path.join(data_dir_fbref + f'/raw/team/*/*/fbref_team_minor_player_stats_against_*_*_latest.csv'))
    ...
    ###
    df_fbref_player_stats_all.to_csv(data_dir_fbref + f'/raw/team/fbref_team_minor_player_stats_against_combined_latest.csv', index=None, header=True)
    
    ### Save a copy to archive folder (dated)
    df_fbref_player_stats_all.to_csv(data_dir_fbref + f'/raw/team/archive/fbref_team_minor_player_stats_combined_against_last_updated_{today}.csv', index=None, header=True)
...
tableName   = "fbref_team_minor_player_stats_against"
